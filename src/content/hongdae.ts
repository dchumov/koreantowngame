...
export interface OutdoorBuilding {
  ...
  bodyColor: number
  roofColor: number
  /** Optional illustrated facade texture loaded from public/assets. */
  texture?: string
  /** Visual-only scale multiplier; collision footprint stays data-driven. */
  textureScale?: number
...
export const enterableBuildings: OutdoorBuilding[] = [
  ...
  },
  {
    ...
    bodyColor: 0x5c2b4d,
    roofColor: 0xc86bab,
    texture: 'building-clothing-shop',
    entranceSide: 'bottom',
    interiorId: 'clothing',
  },
  {
    ...
    bodyColor: 0x4a3a1f,
    roofColor: 0xd7a44a,
    texture: 'building-department-store',
    entranceSide: 'bottom',
  ...
  },
  {
    ...
    h: 150,
    signKo: '달빛 분식',
    signRu: 'Закусочная «Лунный свет»',
    bodyColor: 0x33294f,
    roofColor: 0x7a6ab5,
    entranceSide: 'bottom',
    texture: 'building-snack-bar',
    interiorId: 'cafe',
  },
  {
    id: 'd7',
    ...
    h: 160,
    signKo: '연습실 스튜디오',
    signRu: 'Репетиционная студия',
    bodyColor: 0x2b3350,
    roofColor: 0x6c7fc4,
    entranceSide: 'bottom',
    texture: 'building-rehearsal-studio',
    interiorId: 'music',
  },
  {
    id: 'd8',
    ...
    h: 160,
    signKo: '골목 라멘',
    signRu: 'Рамэн в переулке',
    bodyColor: 0x4f3320,
    roofColor: 0xd08a4a,
    entranceSide: 'bottom',
    texture: 'building-ramen-bar',
...
export const decorBuildings: OutdoorBuilding[] = [
  { id: 'd2', x: 760, y: 470, w: 240, h: 150, signKo: '구름 서점', signRu: 'Книжный «Облако»', bodyColor: 0x24404f, roofColor: 0x5aa2c4, entranceSide: 'bottom', texture: 'building-bookstore' },
  { id: 'd3', x: 2920, y: 470, w: 250, h: 150, signKo: '별빛 문구', signRu: 'Канцтовары «Звёздный свет»', bodyColor: 0x4a2f2f, roofColor: 0xc47f6a, entranceSide: 'bottom', texture: 'building-stationery-shop' },
  { id: 'd4', x: 860, y: 880, w: 250, h: 150, signKo: '하늘 미용실', signRu: 'Салон «Небо»', bodyColor: 0x2f4a36, roofColor: 0x74c48a, entranceSide: 'top', texture: 'building-hair-salon' },
  { id: 'd5', x: 900, y: 1330, w: 250, h: 150, signKo: '노을 떡집', signRu: 'Ток-пекарня «Закат»', bodyColor: 0x50392a, roofColor: 0xd39a63, entranceSide: 'top', texture: 'building-rice-cake-shop' },
  { id: 'd6', x: 2760, y: 880, w: 250, h: 150, signKo: '바람 꽃집', signRu: 'Цветы «Ветер»', bodyColor: 0x3f2f4f, roofColor: 0xa87fc4, entranceSide: 'top', texture: 'building-flower-shop' },
  { id: 'd9', x: 2760, y: 1330, w: 250, h: 160, signKo: '홍대 문화센터', signRu: 'Культурный центр Хондэ', bodyColor: 0x23404a, roofColor: 0x57b0c4, entranceSide: 'top', texture: 'building-culture-center' },
  { id: 'd10', x: 1500, y: 1860, w: 280, h: 180, signKo: '작은 공연장', signRu: 'Небольшой концертный зал', bodyColor: 0x40254a, roofColor: 0xb06fc4, entranceSide: 'top', texture: 'building-concert-hall' },
  { id: 'd11', x: 500, y: 2010, w: 240, h: 140, signKo: '동네 슈퍼', signRu: 'Районный супермаркет', bodyColor: 0x2f4030, roofColor: 0x77b877, entranceSide: 'top', texture: 'building-neighborhood-market' },
